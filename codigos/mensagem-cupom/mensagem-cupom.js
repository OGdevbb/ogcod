...
const COMPONENT = {
  title:       'Popup de Boas-Vindas com Cupom',
  description: 'Popup que aparece automaticamente ao entrar na loja com logo, mensagem de boas-vindas e botao de cupom de desconto copiavel. Cores, textos e glow totalmente customizaveis.',
  tags:        ['Popup', 'Cupom', 'Desconto', 'CSS', 'JS', 'Gratis'],

  fields: [
    // Conteudo
    { id: 'logoUrl',      label: 'URL da Logo (deixe vazio para ocultar)', type: 'text',  placeholder: 'https://...', default: '', required: false },
    { id: 'titulo',       label: 'Titulo',                                  type: 'text',  placeholder: 'Ex: BEM-VINDO',              default: 'BEM-VINDO',                              required: true  },
    { id: 'texto',        label: 'Texto de boas-vindas',                    type: 'text',  placeholder: 'Ex: Seja bem-vindo...',       default: 'Seja bem-vindo! Antes de comprar, leia a descricao do produto.',  required: false },
    { id: 'labelCupom',   label: 'Label acima do cupom',                    type: 'text',  placeholder: 'Ex: CUPOM DE DESCONTO',       default: 'CUPOM DE DESCONTO',                      required: false },
    { id: 'codigoCupom',  label: 'Codigo do Cupom',                         type: 'text',  placeholder: 'Ex: DESCONTO10',              default: 'DESCONTO10',                             required: true  },
    { id: 'msgCopiado',   label: 'Mensagem apos copiar',                    type: 'text',  placeholder: 'Ex: Cupom copiado!',          default: 'Cupom copiado!',                         required: false },

    // Layout
    { id: 'larguraMaxima', label: 'Largura maxima do popup', type: 'text', placeholder: 'Ex: 370px', default: '370px', required: true  },
    { id: 'borderRadius',  label: 'Border Radius',           type: 'text', placeholder: 'Ex: 28px',  default: '28px',  required: false },
    { id: 'padding',       label: 'Padding interno',         type: 'text', placeholder: 'Ex: 34px 28px 36px', default: '34px 28px 36px', required: false },
    { id: 'blur',          label: 'Backdrop Blur',           type: 'text', placeholder: 'Ex: 4px',   default: '4px',   required: false },
    { id: 'tamanhoLogo',   label: 'Tamanho da Logo',         type: 'text', placeholder: 'Ex: 92px',  default: '92px',  required: false },
    { id: 'radiusLogo',    label: 'Border Radius da Logo',   type: 'text', placeholder: 'Ex: 22px',  default: '22px',  required: false },

    // Cores de fundo e overlay
    { id: 'corFundo',          label: 'Cor de Fundo do Popup',        type: 'color', default: '#050505' },
    { id: 'corRadialCenter',   label: 'Cor Radial Centro (rgba)',      type: 'text',  placeholder: 'Ex: rgba(255,0,0,0.08)',  default: 'rgba(255,0,0,0.08)',  required: false },
    { id: 'corRadialEdge',     label: 'Cor Radial Borda (rgba)',       type: 'text',  placeholder: 'Ex: rgba(0,0,0,0.96)',    default: 'rgba(0,0,0,0.96)',    required: false },

    // Borda e glow
    { id: 'corBorda',      label: 'Cor da Borda',              type: 'color', default: '#ff1a1a' },
    { id: 'corGlow1',      label: 'Cor Glow Principal (rgba)', type: 'text',  placeholder: 'Ex: rgba(255,0,0,0.65)', default: 'rgba(255,0,0,0.65)', required: false },
    { id: 'corGlow2',      label: 'Cor Glow Suave (rgba)',     type: 'text',  placeholder: 'Ex: rgba(255,0,0,0.25)', default: 'rgba(255,0,0,0.25)', required: false },
    { id: 'corGlowInset',  label: 'Cor Glow Interno (rgba)',   type: 'text',  placeholder: 'Ex: rgba(255,0,0,0.08)', default: 'rgba(255,0,0,0.08)', required: false },

    // Botao fechar
    { id: 'corBotaoFechar', label: 'Cor do Botao Fechar (X)', type: 'color', default: '#ff2b2b' },

    // Textos
    { id: 'corTitulo',    label: 'Cor do Titulo',    type: 'color', default: '#ffffff' },
    { id: 'corTexto',     label: 'Cor do Texto',     type: 'text',  placeholder: 'Ex: rgba(255,255,255,0.82)', default: 'rgba(255,255,255,0.82)', required: false },
    { id: 'corSubtitulo', label: 'Cor do Subtitulo', type: 'color', default: '#ff2020' },
    { id: 'tamanhoTitulo',label: 'Tamanho do Titulo',type: 'text',  placeholder: 'Ex: 27px', default: '27px', required: false },
    { id: 'tamanhoTexto', label: 'Tamanho do Texto', type: 'text',  placeholder: 'Ex: 15px', default: '15px', required: false },

    // Botao cupom
    { id: 'corBotao1',      label: 'Cor Botao Superior',   type: 'color', default: '#ff2a2a' },
    { id: 'corBotao2',      label: 'Cor Botao Inferior',   type: 'color', default: '#ff0000' },
    { id: 'corTextoBotao',  label: 'Cor Texto do Botao',   type: 'color', default: '#ffffff' },
    { id: 'corMsgCopiado',  label: 'Cor Mensagem Copiado', type: 'color', default: '#27ff7a' },
  ],
};
