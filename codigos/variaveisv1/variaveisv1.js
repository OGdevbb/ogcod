...
function renderPreview() {
  ...
  var doc = '<!DOCTYPE html><html><head><meta charset="UTF-8"><style>body{margin:0;background:#09090f;color:#fff;display:flex;align-items:center;justify-content:center;min-height:100vh;padding:20px;font-family:system-ui,sans-serif;} .container{width:100%;max-width:720px;} .item, label[class*=\"item\"], div[class*=\"Item\"]{display:block;}</style></head><body><div class="container"><label class="item"><input type="radio" name="og" checked><strong>Opção 1</strong><div>Seleção neon</div></label><label class="item"><input type="radio" name="og"><strong>Opção 2</strong><div>Mais beleza</div></label></div><script>' + BASE_JS + '<\/script></body></html>';
