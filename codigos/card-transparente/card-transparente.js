...
const BASE_HTML_B64 = '';
const BASE_CSS_B64  = '';
const BASE_JS_B64   = '';
...
function hover(els) {
  els.forEach(function(el) {
    el.addEventListener('mouseenter', function() {
      oC.style.width = oC.style.height = '20px';
      oR.style.width = oR.style.height = '56px';
    });
    el.addEventListener('mouseleave', function() {
      oC.style.width = oC.style.height = '12px';
      oR.style.width = oR.style.height = '36px';
    });
  });
}
...
function renderPreview() {
  ...
  var doc =
    ...
    + 'body{background:#0d0d0d;display:flex;align-items:flex-start;justify-content:flex-start;min-height:480px;padding:26px;font-family:system-ui,sans-serif;}'
    + '.product_card{'
      + 'width:240px;min-height:140px;border-radius:' + borderRadius + ';padding:20px;'
      + 'background:'
